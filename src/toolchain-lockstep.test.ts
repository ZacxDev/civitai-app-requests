 ...
 *
 * That is not hypothetical here. Until this file landed, this repo had no
 * flake at all and the workflow pinned `node-version: 20` — a release that
 * reached end-of-life on 2026-04-30 and has since been REMOVED from nixpkgs.
 * So the only stated toolchain in the repo was one no `nix develop` on any
 * machine could reproduce, and "works on my node" was the whole story.
 *
